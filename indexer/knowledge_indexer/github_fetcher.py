...
def fetch_articles(
    repo_name: str = GITHUB_REPO, branch: str = GITHUB_BRANCH
) -> list[Article]:
    """Pull every markdown article under DOCS_PREFIXES from the MkDocs repo.
    ...
    for entry in tree.tree:
        ...
        articles.append(
            Article(
                ...
                content=body,
                category=_category_from_path(entry.path, prefix),
